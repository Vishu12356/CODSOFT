...
public class AppGUI extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == addButton) {
            ...
            String sql = "INSERT INTO firstdb VALUES('" + studentIdField.getText() + "', '"
            ...
            // Display all firstdb in database
            String sql = "SELECT * FROM firstdb";
            ...
            // Sort firstdb by selected column
            ...
            String sql = "";
            switch (choice) {
                case 0 -> sql = "SELECT * FROM firstdb ORDER BY first_name";
                case 1 -> sql = "SELECT * FROM firstdb ORDER BY last_name";
                case 2 -> sql = "SELECT * FROM firstdb ORDER BY major";
                default -> {
                }
            }
            try {
            ...
            String sql = "SELECT * FROM firstdb WHERE " + column + " LIKE '%" + searchTerm + "%'";
            ...
            String sql = "SELECT * FROM firstdb WHERE student_id = '" + studentId + "'";
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    sql = "UPDATE firstdb SET " + column + " = '" + newValue + "' WHERE student_id = '" + studentId + "'";
